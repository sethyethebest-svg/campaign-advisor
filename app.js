...
const copy = {
  en: {
    ...
    heroPrimaryCta: "Try the live demo",
    heroSecondaryCta: "See why it works",
    heroSignalForecast: "Live forecast",
    heroSignalContinuous: "Continuous variables",
    heroSignalRanking: "Top 2 ranking",
    storyEyebrow: "Built for local tea operators",
    storyTitle: "Weather changes the moment customers decide to leave home.",
    storyIntro:
      "The product should feel useful before the operator touches a model. These are the decisions a bubble tea team actually makes each morning.",
    storyRainEyebrow: "Rainy weekday",
    storyRainTitle: "Turn foot-traffic risk into delivery demand.",
    storyRainText:
      "When rain probability rises, the operator can shift budget from walk-in offers to delivery-first acquisition.",
    storyHeatEyebrow: "Hot afternoon",
    storyHeatTitle: "Protect margin when demand is already high.",
    storyHeatText:
      "Hot days may not need aggressive discounting, so the model can surface lighter incentives or CAC-aware choices.",
    storyOpsEyebrow: "Store operations",
    storyOpsTitle: "Give managers two good options, not a black-box answer.",
    storyOpsText:
      "The workflow ranks the top 2 so humans can still account for inventory, staffing, and local events.",
    ...
    methodEyebrow: "Logic source",
    methodTitle: "A credible path from weather data to marketing action.",
    methodIntro:
    ...
    pipelineDecisionText: "Top 2 recommendation, metric toggle, and local override.",
    benchmarkTitle: "20-chain bubble tea benchmark universe",
    benchmarkText:
      "A pilot can compare campaigns against a recognizable U.S. bubble tea landscape. Names below are a sample benchmark universe, not claimed partner data.",
    ...
    appTitle: "iOS companion app for richer store-day execution.",
    appText:
      "The web console is for planning and interviews. The future iOS app can bring push alerts, store checklists, manager overrides, and campaign reminders into daily operations.",
    appScreenLabel: "Today",
    appScreenTitle: "Rain risk rising",
    appScreenText: "Switch to delivery acquisition before 2 PM.",
    appCta: "Download iOS app soon",
  ...
  zh: {
    ...
    heroPrimaryCta: "试用实时 demo",
    heroSecondaryCta: "查看逻辑来源",
    heroSignalForecast: "实时天气",
    heroSignalContinuous: "连续变量",
    heroSignalRanking: "Top 2 排名",
    storyEyebrow: "为本地茶饮运营者设计",
    storyTitle: "天气会改变用户出门消费的那一刻。",
    storyIntro:
      "产品要在用户理解模型之前先显得有用。下面是奶茶门店每天早上真的会做的 campaign 决策。",
    storyRainEyebrow: "下雨工作日",
    storyRainTitle: "把线下客流风险转成外卖需求。",
    storyRainText:
      "当降雨概率升高，运营者可以把预算从到店优惠切到外卖获客 campaign。",
    storyHeatEyebrow: "高温下午",
    storyHeatTitle: "需求已经高时，优先保护毛利。",
    storyHeatText:
      "高温天可能不需要重折扣，模型会更偏向轻促销或 CAC 更健康的选择。",
    storyOpsEyebrow: "门店运营",
    storyOpsTitle: "给店长两个好选择，而不是黑盒答案。",
    storyOpsText:
      "工作流输出 top 2，让人仍然可以结合库存、人手和本地活动做最后判断。",
    ...
    methodEyebrow: "逻辑来源",
    methodTitle: "从天气数据到营销动作，要有可信路径。",
    methodIntro:
      "当前 demo 使用透明的样例系数。生产环境中，同一界面可以学习门店日级 campaign 历史、广告花费、POS 订单和本地天气。",
    pipelineTitle: "数据链路",
    pipelineWeatherTitle: "天气预测",
    pipelineWeatherText: "浏览器定位 + Open-Meteo 未来 7 天天气。",
    pipelineBusinessTitle: "业务结果",
    pipelineBusinessText: "门店日级 P-ROAS、CAC、订单和 campaign spend。",
    pipelineModelTitle: "透明模型",
    pipelineModelText: "additive regression，天气变量保持连续。",
    pipelineDecisionTitle: "人工决策",
    pipelineDecisionText: "输出 top 2、可切换目标、允许本地 override。",
    benchmarkTitle: "20 家美国奶茶连锁 benchmark universe",
    benchmarkText:
      "试点时可以把 campaign 逻辑对齐到一个可识别的美国奶茶竞争格局。以下是样例 benchmark universe，不代表合作或官方数据。",
    modelEyebrow: "05 模型逻辑",
    modelTitle: "模型假设与 campaign 效应",
    modelHint: "同一个 additive model 先计算每个 day x campaign，再输出 top 2。",
    appEyebrow: "下一阶段",
    appTitle: "iOS companion app，让门店日常执行更完整。",
    appText:
      "网页适合规划和面试展示。未来 iOS app 可以把推送提醒、门店 checklist、店长 override 和 campaign reminder 带进每天运营。",
    appScreenLabel: "今日",
